    ...
    <>
      <AnimatePresence>
        ...
        onClick={event => event.stopPropagation()}
         className="burgermenu md:hidden font-atma text-white fixed bg-secondary-dark flex flex-col items-center left-0 w-[300px] h-full">
          <IoMdClose
          ...
          <div className="nav flex flex-col items-center text-xl gap-4 w-full">
